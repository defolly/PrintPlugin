...
public class PrintPlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        if (action.equals("openBluetooth")) {
            ...
            return true;
             ...
             String arg4 = args.getString(4);
             String arg5 = args.getString(5);
             String arg6 = args.getString(6);
             String arg7 = args.getString(7);
             String arg8 = args.getString(8);
             this.printBarcode(arg0, arg1, arg2, arg3, arg4, arg5,arg6,arg7,arg8);
             return true;
     ...
     * @param arg8
     */
    private void printBarcode(String arg0, String arg1, String arg2, String arg3, String arg4, String arg5,String arg6,String arg7,String arg8) {
        // 判断有没有配对
        if (!isPaired) {
            //System.out.println("还没配对，请先配对");
            this.mCallback.error("还没配对，请先配对!");
         ...
         */
        HPRTPrinterHelper.SetBold("2");
        HPRTPrinterHelper.Text(HPRTPrinterHelper.TEXT, "4", "0", "0", "5", arg0);

        HPRTPrinterHelper.SetBold("2");
        HPRTPrinterHelper.AutLine("0", "40", 510, 4, arg1);
        
        

        HPRTPrinterHelper.SetBold("2");
        HPRTPrinterHelper.Text(HPRTPrinterHelper.TEXT, "4", "0", "0", "120", arg2);

        HPRTPrinterHelper.SetBold("2");
        HPRTPrinterHelper.Text(HPRTPrinterHelper.TEXT, "4", "0", "250", "120", arg3);

        HPRTPrinterHelper.SetBold("2");
        HPRTPrinterHelper.Text(HPRTPrinterHelper.TEXT, "4", "0", "0", "155", arg4);

        if(arg4.length()>12){
             HPRTPrinterHelper.SetBold("2");
             HPRTPrinterHelper.Text(HPRTPrinterHelper.TEXT, "4", "0", "310", "155", arg5);
        }else{
        	 HPRTPrinterHelper.SetBold("2");
             HPRTPrinterHelper.Text(HPRTPrinterHelper.TEXT, "4", "0", "250", "155", arg5);
        }
        
        HPRTPrinterHelper.SetBold("2");
        HPRTPrinterHelper.Text(HPRTPrinterHelper.TEXT, "4", "0", "0", "190", arg6);

        HPRTPrinterHelper.SetBold("2");
        HPRTPrinterHelper.Text(HPRTPrinterHelper.TEXT, "4", "0", "250", "190", arg7);
        
        HPRTPrinterHelper.SetBold("0");
        HPRTPrinterHelper.Barcode(HPRTPrinterHelper.BARCODE, HPRTPrinterHelper.code128, "1", "0", "50", "10", "225", true, "0", "0", "5", arg8);
